/*
  # Create locations table and import location data

  1. New Tables
    - `locations`
      - `id` (uuid, primary key)
      - `organization_id` (uuid, foreign key to organizations)
      - `location_code` (text, unique within organization)
      - `location_name` (text)
  ...
  3. Data Import
    - Import all location data from CSV
    - Handle duplicates by keeping the first occurrence
    - Link locations to organizations via org_code
*/
...
-- Insert all location data from the provided CSV, handling duplicates
WITH location_data AS (
    SELECT DISTINCT ON (org_code, location_code)
        org_code,
        location_code,
        location_name,
        street,
    ...
    FROM (VALUES
        ...
        ('AMMO', 'TEST1', 'TEST Location', '123 ABC Way', NULL, NULL, NULL, NULL, NULL),
        ...
        ('AMGA', 'TEST2', 'TEST Location', '123 ABC Way', NULL, NULL, NULL, NULL, NULL),
        ...
        ('AMTXSealy', 'TEST3', 'TEST Location', '123 ABC Way', NULL, NULL, NULL, NULL, NULL),
        ('AMTXStockton', 'MallMC', 'Mallik Medical Clinic', '237 W 21st Street', 'Fort Stockton', 'Texas', '79735', NULL, NULL),
        ('AMTXStockton', 'TEST4', 'TEST Location', NULL, NULL, NULL, NULL, NULL, NULL),
        ...
        ('CSPI', 'TEST5', 'TEST Location', '123 ABC Way', NULL, NULL, NULL, NULL, NULL),
        ('FMC', 'FMC_Brownsville', 'Brownsville', '1215 E College Street', 'Brownsville', 'Tennessee', '38012', '7317723442', NULL),
        ('FMC', 'FMC_Jackson', 'Jackson', '168 W University Parkway, Suite A', 'Jackson', 'Tennessee', '38305', NULL, NULL),
        ('FMC', 'TEST6', 'Test Location', NULL, NULL, NULL, NULL, NULL, NULL),
        ...
        ('TEST', 'TEST7', 'TEST Location', '123 ABC Way', NULL, NULL, NULL, NULL, NULL)
    ) AS raw_data(org_code, location_code, location_name, street, city, state, zip, phone, fax)
)
